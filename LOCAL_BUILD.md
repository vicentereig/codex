...
```text
codex-cli 0.145.0-alpha.24-vicentes-version.0.4.0+openai.312caf176a
```

The first portion records the upstream Codex release, `vicentes-version.0.4.0`
...
Fork releases use annotated tags such as `vicente-v0.4.0`. The tag message
