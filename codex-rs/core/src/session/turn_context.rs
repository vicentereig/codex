...
pub struct TurnContext {
    ...
    /// In-memory ownership of children delegated by this turn.
    pub(crate) delegation_ledger: Arc<DelegationLedger>,
...
impl TurnContext {
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            delegation_ledger: self.delegation_ledger.clone(),
    ...
    async fn new_turn_context_from_configuration(
        ...
        let multi_agent_version = match multi_agent_runtime {
            ...
            TurnMultiAgentRuntime::Preview => self.multi_agent_version().unwrap_or_else(|| {
                per_turn_config.multi_agent_version_for_model(model_info.multi_agent_version)
            }),
        };
